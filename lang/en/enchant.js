...
enchant.DOMSound.load = function(src, type, callback, onerror) {
    ...
    var audio = new Audio();
    // The original first test disables audio on Android, which is a shame, frankly.
    // We're going to remove this check altogether.

    // TODO: Create Global Audio management class to handle touch-to-start, mono/multi-sound, WebAudio, audio queueing.
    // TODO: Use simpler flags to enable/disable audio on various devices
